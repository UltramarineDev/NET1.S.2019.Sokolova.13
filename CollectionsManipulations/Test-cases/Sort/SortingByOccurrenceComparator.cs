...
{
    /// <summary>
    /// SortingByOccurrenceComparator class with implementation of IComparer interface and NumberOfOccurrences class
    /// </summary>
    public class SortingByOccurrenceComparator<TSource> : NumberOfOccurrences, IComparer<string>
    {
        /// <summary>
